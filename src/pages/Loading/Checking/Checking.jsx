      ...
      <div className="mt-6 grid gap-8 md:grid-cols-2 md:gap-8">
        <div className="p-4 md:p-5  text-sm md:text-base leading-relaxed">
          ...
          <p className="mt-2">
            ...
            стройматериалов, не требующих поддержания температуры. Тент защищает груз от осадков и
            грязи, а каркас и растяжки — от потери формы.
          </p>
        ...
        <div className=" p-4 md:p-5 text-sm md:text-base leading-relaxed">
          ...
          <ul className="ml-5 list-disc space-y-2">
            <li>
              Работу холодильной установки и способность поддерживать заданный режим (как правило,
              от +5°C до +23°C в зависимости от груза).
            </li>
